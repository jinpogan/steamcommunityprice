...
pricejson = os.popen('''curl "https://steamcommunity.com/market/priceoverview/?appid=730&currency=1&market_hash_name=''' + itemname +'''"''').read() # example Sticker%20|%20Kawaii%20Killer%20Terrorist
print(pricejson)
